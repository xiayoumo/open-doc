...
export default {
    ...
    section_title9: 'ProductRequirement Document',
    section_description9: 'OpenDoc provides a markup editor function, allowing products to move from "conceptualization" to "drawing"',
    section_title10: 'Desk Diary',
    section_description10: 'A good memory is not as good as a bad pen, OpenDoc is the best writing pad for work and office',
    section_title11: 'Work Summary',
    section_description11: 'Doing well is not as good as summarizing well. Summarizing well is inseparable from the perfect support of OpenDoc',
    ...
    page_diff_tips: 'What is the difference between a project page address and a single page address?',
