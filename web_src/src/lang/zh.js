...
export default {
    ...
    section_title7: '在线托管',
    section_description7: 'open-doc.docker-sky.cn 提供安全稳定的在线文档托管服务<br>您可以放心地选择托管你的文档数据在云端',
    section_title8: '立即体验',
    section_description8: '超过6000+互联网团队正在使用OpenDoc',
    section_title9: '产品文档',
    section_description9: 'OpenDoc集成了markdown编辑器<br>高效支持产品从概念化进入到图纸化',
    section_title10: '办公日记',
    section_description10  : '好记性不如烂笔头<br>OpenDoc是工作办公的最佳写字板',
    section_title11: '工作总结',
    section_description11: '做的好不如总结的好<br>总结得好离不开OpenDoc的完美支持',
