...
return array(
  ...
  "db_name"=>'数据库名，建议数据库名为opendoc',
  "db_user"=>'数据库用户名',
  "db_password"=>'数据库密码',
  "sqlite_tips"=>'PHP内置支持Sqlite数据库，你无须再配置数据库，直接点击开始即可',
  "go"=>'开始',
  "install_success_help"=>'安装成功！默认管理员账户密码是opendoc/opendoc123456。登录后，在右上角可以看到管理后台入口。此外，强烈建议修改管理员初始密码。若再遇到问题，可参考OpenDoc帮助文档：<a href="'.$homeUrl.'" target="_blank">'.$homeUrl.'/help</a>',
  "home"=>'进入网站首页',
  "FAQ"=>'常见问题',
  ...
  "not_writable_sqlite_db"=>'请赋予 Sqlite/opendoc.db.php 以可写权限！',
