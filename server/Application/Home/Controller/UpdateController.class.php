...
class UpdateController extends BaseController {
    ...
    public function sqlite(){
        ...
        //管理员账户和权限
        if(D("User")->where("username = 'opendoc' ")->find()){
            D("User")->where("username = 'opendoc' ")->save(array("groupid"=> 1)) ;
        }else{
             D("User")->add(array('username'=>"opendoc" ,"groupid"=>1,'password'=>"a89da13684490eb9ec9e613f91d24d00" , 'reg_time'=>time()));
        }
